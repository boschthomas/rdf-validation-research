...
\tb{ToDo: RDF Validation Requirements Not Covered by OWL 2 QL But by ShEx}

Table~\ref{tab:RequirementsCoveredShEx}

\subsubsection{RDF Validation Requirements Not Covered by OWL 2 QL But by SPIN and SPARQL}

\begin{itemize}
	\item SPIN as an instantiation of constraint languages which are low-level and the most expressive 
\end{itemize}

\tb{ToDo: RDF Validation Requirements Not Covered by OWL 2 QL But by SPIN and SPARQL}
\tb{ToDo: RDF Validation Requirements Not Covered by OWL 2 QL But by DQTP}
