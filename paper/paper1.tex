...
\begin{itemize}
	\item see R-53-NEGATIVE-DATA-PROPERTY-CONSTRAINTS
...
\begin{itemize}
  ...
  \item OWL 2 DL: ObjectComplementOf ( DataSomeValuesFrom ( DataPropertyExpression rdfs:Literal ) )
	\item covering approaches: ShEx, SPIN
\end{itemize}
...
A matching triple has any object except those excluded by the '-' operator.
